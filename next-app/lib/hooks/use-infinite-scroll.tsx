...
const useInfiniteScrollGQL = (
    ...
    }, [state.isLoading, state.items.length, state.total, state.offset, state.calledOffsets, isVisible, isFetchingNextPage, fetchNextPage]); // Include all dependencies here
